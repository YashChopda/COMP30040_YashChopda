...
void validation()
{
 if (LIMITCYCLE == 12 || LIMITCYCLE == 16 ||
  LIMITCYCLE == 15 || LIMITCYCLE == 13 ||
  LIMITCYCLE == 14)
 {
  if (0 == 0)
  {
 ...
 if (((LIMITCYCLE != 9) && (LIMITCYCLE != 10) &&
   (LIMITCYCLE != 11)) && (ds.a_size == 0 || ds.b_size == 0))
 {
  printf("\n\n****************************************************************************\n");
 ...
 if ((LIMITCYCLE == 3) || (LIMITCYCLE == 2) || (LIMITCYCLE == 1) ||
   (LIMITCYCLE == 10) || (LIMITCYCLE == 11) ||
   (LIMITCYCLE == 4 || LIMITCYCLE == 5) || LIMITCYCLE == 6)
 {
  if ((10 == 0) && !(0 == 1))
  {
   printf("\n\n********************************************************************************************\n");
 ...
 if ((1 == 0) && (LIMITCYCLE != 9) && (LIMITCYCLE != 18))
 {
  printf("\n\n*********************************************************************************************\n");
 ...
 if (LIMITCYCLE == 4 || LIMITCYCLE == 5)
 {
  if (LIMITCYCLE == 5 || LIMITCYCLE == 4)
  {
   if (hw.clock == 0l)
   {
    printf("\n\n***************************\n");
